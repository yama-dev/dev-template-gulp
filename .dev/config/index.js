...
let CONFIG = {
  ...
  watchIgnoreDirectory: {
    ...
    ejs : [
      `!${CONFIG_PATH.sourceBuild}**/_*.ejs`,
      `!${CONFIG_PATH.sourceBuild}_*/**/*.ejs`,
      `!${CONFIG_PATH.sourceBuild}__*/**/*.ejs`,
      `!${CONFIG_PATH.sourceBuild}___*/**/*.ejs`,
    ],
    pug : [
      `!${CONFIG_PATH.sourceBuild}**/_*.pug`,
      `!${CONFIG_PATH.sourceBuild}_*/**/*.pug`,
      `!${CONFIG_PATH.sourceBuild}__*/**/*.pug`,
      `!${CONFIG_PATH.sourceBuild}___*/**/*.pug`,
    ],
    slim : [
      `!${CONFIG_PATH.sourceBuild}**/_*.slim`,
      `!${CONFIG_PATH.sourceBuild}_*/**/*.slim`,
      `!${CONFIG_PATH.sourceBuild}__*/**/*.slim`,
      `!${CONFIG_PATH.sourceBuild}___*/**/*.slim`,
    ],
    sass : [
      `!${CONFIG_PATH.sourceBuild}**/wp/**/*.scss`,
      `!${CONFIG_PATH.sourceBuild}**/vender/**/*.scss`,
      `!${CONFIG_PATH.sourceBuild}**/vendor/**/*.scss`,
      `!${CONFIG_PATH.sourceBuild}**/lib/**/*.scss`,
      `!${CONFIG_PATH.sourceBuild}**/libs/**/*.scss`,
      `!${CONFIG_PATH.sourceBuild}_*/**/*.scss`,
      `!${CONFIG_PATH.sourceBuild}__*/**/*.scss`,
      `!${CONFIG_PATH.sourceBuild}___*/**/*.scss`,
    ],
    css : [
